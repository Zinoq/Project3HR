...
public class Barchart extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        series1.getData().add(new XYChart.Data(Dijkzigt, Double.parseDouble(Database.execute("SELECT year_2006 FROM tevredenheid_met_het_wonen_in_de_buurt WHERE wijk='Cool/Nieuwe, Werk/Dijkzigt';", "year_2007").get(7))));
